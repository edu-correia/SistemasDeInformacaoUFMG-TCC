...
# CONFIGURATION
# ==========================================
GEMINI_API_KEY = "AIzaSyAiwcZB4EILcjQz2k8trGfXjiYJBQD-esk" # <--- REPLACE THIS
...
# Use 2.0 Flash as requested for speed, high limits, and low cost
    ...
    with open(PROGRESS_FILE, 'a', encoding='utf-8') as progress_file:
        for batch in tqdm(batches, desc="Ranking batches via Gemini"):
            ...
            try:
                ...
                # Slight pause to respect API rate limits (Adjust based on your API tier)
                # Gemini 2.0 Flash is fast, but 200,000 requests can trigger RPM limits
                # time.sleep(4) 
